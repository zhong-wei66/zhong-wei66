...
public class TestCalendar {
	public static void main(String[] args) {
		...
		int month=calendar.get(Calendar.MONTH);//0-11表示对应的月份，0是1月
		int day=calendar.get(Calendar.DATE);
		int weekday=calendar.get(Calendar.DAY_OF_WEEK);//星期几：1-7；1：星期天，2：星期一
	...
	public static void printCalendar(Calendar c) {
		...
		int dayweek=c.get(Calendar.DAY_OF_WEEK)-1;//1-7,1:星期天 2：星期一
